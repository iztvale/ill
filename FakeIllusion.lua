...
-- <======================================================> --
-- Github: https://github.com/MrGarabato19
-- Umbrella : https://uc.zone/members/41845/
-- <======================================================> --

local FakeIllusion = {}
FakeIllusion.optionEnable = Menu.AddOptionBool({"Utility", "Illusions Fake Movement"}, "Activation", false)
