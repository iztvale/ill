...
Furion.enablecombo = Menu.AddOptionBool({"Hero Specific", "Furion"}, "Enable Combo?", false)
Furion.key = Menu.AddKeyOption({ "Hero Specific", "Furion" }, "Combo Key", Enum.ButtonCode.KEY_F)
Furion.enableblock = Menu.AddOptionBool({"Hero Specific", "Furion"}, "Enable Treant Block in combo?", false)
Furion.addsprout = Menu.AddOptionBool({"Hero Specific", "Furion", "Combo"}, "Sprout", false)
Furion.addhex = Menu.AddOptionBool({"Hero Specific", "Furion", "Combo"}, "Hex (Scythe if Vyse)", false)
Furion.addorchid = Menu.AddOptionBool({"Hero Specific", "Furion", "Combo"}, "Orchid", false)
Furion.addbloodthorn = Menu.AddOptionBool({"Hero Specific", "Furion", "Combo"}, "Bloodthorn", false)
